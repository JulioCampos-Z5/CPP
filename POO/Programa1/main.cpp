...
void PRESTAMOS()
{
    ...
    while (opc != 4)
    {
        ...
        {
        case 1:
            prestamos[totalPrestamos].Registrar(prestamos, libros, usuarios, totalPrestamos, totalLibros, totalUsuarios);
            break;
        case 2:
            prestamos[totalPrestamos].Mostrar(prestamos, totalPrestamos);
            break;
        case 3:
            prestamos[totalPrestamos].Eliminar(prestamos, totalPrestamos);
            break;
        case 4:
            Menu();
            break;
